...
# # Generate an unfair ranking & re-rank it to be fair
# Here you can generate an unfair ranking, use DetConSort to re-rank it, and see how the ranking becomes fairer.
